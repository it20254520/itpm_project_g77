...
export default class CreateBooking extends Component{
    constructor(props){
        ...
        const {First_name,Last_name,Email,Mobile,NIC_number,Adult,Children,Singale_room,Double_room,Triple_room,Check_in,Check_out,Cardholder_name,Card_type,Card_number,Security_code,Expiry_date} = this.state;
        ...
        axios.post("http://localhost:8070/Booking/save",data).then((res) =>{
        if(res.data.success){
        this.setState(
        {
            First_name:"",
        ...
        <div className="col-md-8 mt-4 mx-auto">
            <h1 className="h3 mb-3 font-weight-normal">Create New Room Booking</h1>
