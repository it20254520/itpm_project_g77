...
export default class PostEventPackageDetails extends Component {
    constructor(props){
        super(props);
...
render() {
const {Category,Capacity,SelectHalls,Serving,SelectSeatingStyles,DecorationInformations,AddServices,AdditionalServices,DiscribeYourEvent} = this.state.post;
